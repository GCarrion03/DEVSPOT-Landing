...
const questionBank = [
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "The root volume must be an instance store volume. E. The launch Configuration is changed."
            }
        ],
        "questionAnswer": "BC"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Scale the number of processing nodes based on pending order volume. E. Have a standby Amazon RDS instance in a separate Availability Zone."
            }
        ],
        "questionAnswer": "CD"
    },
    ...
    {
        "questionId": 148,
        "questionText": "An organization runs an online voting system for a television program. During broadcasts, hundreds of thousands of votes are submitted within minutes and sent to a front-end eet of auto-scaled Amazon EC2 instances. The EC2 instances push the votes to an RDBMS database. The database is unable to keep up with the front-end connection requests. What is the MOST e cient and cost-effective way of ensuring that votes are processed in a timely manner?",
        "questionOptions": [
            {
                "optionId": "A",
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Create an IPSec VPN tunnel between the customer site and the VPC, and use the VPN tunnel to connect to the database. E. Attach an Elastic IP address to the database."
            }
        ],
        "questionAnswer": "AD"
    },
    ...
    {
        "questionId": 164,
        "questionText": "A company plans to use an Amazon VPC to deploy a web application consisting of an elastic load balancer, a eet of web and application servers, and an Amazon RDS MySQL database that should not be accessible from the Internet. The proposed design must be highly available and distributed over 4 two Availability Zones. What would be the MOST appropriate VPC design for this speci c use case?",
        "questionOptions": [
            {
                "optionId": "A",
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Create a dedicated Elastic Load Balancer for each microservice E. Create RDS read replicas and change the application to use these replicas"
            }
        ],
        "questionAnswer": "AE"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Configure the web servers to communicate with RDS by using SSL, and issue certi cates to the web tier EC2 instances. E. Create a customer master key in AWS KMS and apply it to encrypt the RDS instance."
            }
        ],
        "questionAnswer": "AD"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Create the platform endpoints for mobile devices and subscribe the SNS topic with platform endpoints. E. Subscribe the SNS topic with an Amazon SQS queue, and poll the messages continuously from the queue. Use each mobile platform's libraries to send the message to the mobile application."
            }
        ],
        "questionAnswer": "AD"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Scale out using an Auto Scaling group for RDS. E. Use RDS in a separate AWS Region."
            }
        ],
        "questionAnswer": "BC"
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Pre-process data to consolidate multiple records to minimize write operations. E. Export the old table data from DynamoDB to Amazon S3 using AWS Data Pipeline, and delete the old table."
            }
        ],
        "questionAnswer": "CE"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "AWS CloudFormation with Lambda Custom Resources without VPC for the web application, and an Amazon RDS for MySQL database. E. AWS CloudFormation with Lambda Custom Resources running in a VPC for the web application, and an Amazon RDS for MySQL database."
            }
        ],
        "questionAnswer": "AC"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Another master user is created E. A failure of the primary database instance"
            }
        ],
        "questionAnswer": "CE"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Amazon DynamoDB E. Amazon RDS for Microsoft SQL Server"
            }
        ],
        "questionAnswer": "BC"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Use an Application Load Balancer (ALB) with an HTTPS listener, then install SSL certi cates on the ALB and EC2 instances. E. Use a Network Load Balancer (NLB) with an HTTPS listener, then install SSL certi cates on the NLB and EC2 instances."
            }
        ],
        "questionAnswer": "CD"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "How long it takes for the Auto Scaling group to detect a failure. E. How long the bootstrap script takes to run."
            }
        ],
        "questionAnswer": "CE"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Deploy AWS KMS to identify users. E. Assign permissions in AWS IAM to allow users."
            }
        ],
        "questionAnswer": "AE"
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Set up a geolocation routing policy to distribute the workload between the load balancer and the on-premises environment. E. Set up a routing policy for failover using the on-premises environment as primary and the load balancer as secondary."
            }
        ],
        "questionAnswer": "AB"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Increase the SQS queue attribute for the message retention period E. Convert the SQS queue to a rst-in rst-out (FIFO) queue"
            }
        ],
        "questionAnswer": "CE"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Create an S3 lifecycle policy that moves the data to Amazon S3 Standard-Infrequent Access (S3 Standard-IA) after 35 days E. Creates an S3 lifecycle policy that moves the data to the GLACIER storage class after 35 days"
            }
        ],
        "questionAnswer": "AE"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Create read replicas in different Availability Zones E. Create an ELB Application Load Balancer"
            }
        ],
        "questionAnswer": "DB"
    },
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Create an AWS Lambda function to monitor website load time, run it every 5 minutes, and use the AWS SDK to create a new instance if website load time is longer than 2 seconds E. Use Amazon CloudFront to cache the website content during launch and set a TTL for cache content to expire after the launch date"
            }
        ],
        "questionAnswer": "AB"
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Add additional EC2 instances with Elastic IP addresses, and register them with Amazon Route 53 E. Switch the two existing EC2 instances for an Auto Scaling group, and register them with the Network Load Balancer."
            }
        ],
        "questionAnswer": "AE"
    },
    ...
    {
        "questionId": 306,
        "questionText": "A three-tier application is being created to host small news articles. The application is expected to serve millions of users. When breaking news occurs, the site must handle very large spikes in traffic without signi cantly impacting database performance. Which design meets these requirements while minimizing costs?",
        "questionOptions": [
            {
                "optionId": "A",
    ...
    },
    {
        ...
        "questionOptions": [
            ...
            {
                "optionId": "D",
                "optionText": "Use client-side encryption before ingesting the data to Amazon S3 using encryption keys. E. Use SSL to encrypt the data while in transit to Amazon S3."
            }
        ],
        "questionAnswer": "BD"
    }
