...
//Use smooth scrolling when clicking on navigation
    ...
    var scene5 = new ScrollMagic.Scene({triggerElement: '#about'}).setVelocity('#about', {opacity: 1}).setVelocity('#about', 'transition.slideDownBigIn', function () {
        $('#about .inner').countTo({
    ...
    $('form #submit').hover(
        function () {
            $('form #submit').velocity({paddingLeft: 10, paddingRight: 10});
        },
        function () {
            $('form #submit').velocity('reverse');
        }
    );
    ...
    $('#carousel1').hover(
        ...
        function () {
            $('.carousel-indicators,.carousel-control').velocity('reverse');
        }
    );
